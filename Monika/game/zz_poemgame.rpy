...
#    $ allow_skipping = False
    ...
    # poem help screen
    if show_poemhelp:
        call screen dialog("Время написать стихотворение!\n\nВыбирай слова которые могут понравится одной из девушек.\n Что-то хорошее может случится с тем,\nкому понравится ваше стихотворение!", ok_action=Return())
